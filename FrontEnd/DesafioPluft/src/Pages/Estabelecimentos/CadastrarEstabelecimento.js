...
class CadastrarEstabelec extends Component {
    ...
    return (
      <View>
        <View style={styles.cabecalho}>
          <Text style={styles.titulo}>Cadastrar Estabelecimento</Text>
        ...
        <View style={styles.body}>
          ...
          <ScrollView>
            <TextInput style={styles.input}
              autoCapitalize="none"
              returnKeyType="next"
              placeholder='CNPJ (Até 14 caracteres)'
            ...
            <TextInput style={styles.input}
              autoCapitalize="none"
              returnKeyType="next"
              placeholder='Id Tipo Estabelecimento'
...
export default CadastrarEstabelec;
