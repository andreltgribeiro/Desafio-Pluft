...
class CadastrarLojista extends Component {
          ...
          if (this.state.Telefone == null || this.state.Telefone == '') {
            ...
            if (this.state.IdEstabelecimento == null || this.state.IdEstabelecimento == '' || this.state.IdEstabelecimento == 0) {
              ...
              if (this.state.DataNascimento == null || this.state.DataNascimento == '') {
                Alert.alert(
                  "Erro",
                  "Informe uma data de nascimento (mm-dd-yyyy)",
                  [
                    { text: "Later", onPress: () => console.log("later pressed") },
                    {
                      text: "Cancel",
                ...
                if (this.state.Rg == null || this.state.Rg == '' || this.state.Rg.length > 9) {
                  ...
                  if (this.state.Endereco == null || this.state.Endereco == '') {
                    ...
                    if (this.state.Cpf == null || this.state.Cpf == '' || this.state.Cpf.length > 11) {
                      ...
                      await api.post("/usuarios/lojistas", {
    ...
    return (
      <View>
        <View style={styles.cabecalho}>
          <Text style={styles.titulo}>Cadastrar Lojista</Text>
