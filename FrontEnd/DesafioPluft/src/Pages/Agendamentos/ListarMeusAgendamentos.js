...
class ListarAgendamentosUserLogado extends Component {
  ...
  carregarMeusAgendamentos = async () => {
    const value = await AsyncStorage.getItem("userToken");
    const resposta = await api.get("/agendamentos/meusagendamentos", {
      headers: {
      ...
      <View style={styles.main}>
        <View style={styles.mainHeader}>
          <View style={styles.mainHeaderRow}>
            ...
            />
            <Text style={styles.mainHeaderText}>{"Meus Agendamentos".toUpperCase()}</Text>
          </View>
  ...
  renderizaItem = ({ item }) => (
    <View style={styles.flatItemLinha}>
      <View style={styles.flatItemContainer}>
        ...
        <Text style={styles.flatItemData}>Endereço Cliente: {item.clienteEnd}</Text>
...
export default ListarAgendamentosUserLogado;
