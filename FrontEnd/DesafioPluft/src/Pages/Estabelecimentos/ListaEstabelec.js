      ...
      <View style={styles.main}>
        ...
        <View style={styles.mainHeader}>
          <View style={styles.mainHeaderRow}>
            ...
            />
            <Text style={styles.mainHeaderText}>{"Estabelecimentos".toUpperCase()}</Text>
          </View>
  ...
  renderizaItem = ({ item }) => (
    ...
    <View style={styles.flatItemLinha}>
      <View style={styles.flatItemContainer}>
        ...
        <Text style={styles.flatItemData}>CNPJ: {item.cnpj}</Text>
        <Text style={styles.flatItemData}>Tipo de Estabelecimento: {item.tipoestabelecimento}</Text>
        <Text style={styles.flatItemData}>Endereço{item.endereco}</Text>
        <Text style={styles.flatItemData}>Horário de Funcionamento{item.horarioFuncionamento}</Text>
        <Text style={styles.flatItemData}>Vagas{item.vagas}</Text>
      </View>
    </View>
  );
}
